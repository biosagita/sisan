<div id="88_tlbvideo" style="padding:5px;">
	<div style="float:left;">
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="fnAddvideo_88()">Add</a>
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="fnEditvideo_88()">Edit</a>
...
<table id="88_dtgvideo" class="easyui-datagrid" data-options="title:'Data video',url:'<?php echo base_url(); ?>index.php/md_video/fnvideoData/',toolbar:'#88_tlbvideo',rownumbers:false,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'id_video',title:'<b>Id</b>',width:40,sortable:true" halign="center"></th>
