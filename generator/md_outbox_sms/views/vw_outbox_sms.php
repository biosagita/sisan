<div id="75_tlboutbox_sms" style="padding:5px;">
...
<table id="75_dtgoutbox_sms" class="easyui-datagrid" data-options="title:'Data outbox_sms',url:'<?php echo base_url(); ?>index.php/md_outbox_sms/fnoutbox_smsData/',toolbar:'#75_tlboutbox_sms',rownumbers:false,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'f_outbox_id',title:'<b>Id</b>',width:40,sortable:true" halign="center"></th>
