<div id="80_tlbgroup_loket" style="padding:5px;">
...
<table id="80_dtggroup_loket" class="easyui-datagrid" data-options="title:'Data group_loket',url:'<?php echo base_url(); ?>index.php/md_group_loket/fngroup_loketData/',toolbar:'#80_tlbgroup_loket',rownumbers:false,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'id_group_loket',title:'<b>Id</b>',width:40,sortable:true" halign="center"></th>
           
		   <th data-options="field:'nama_group_loket',title:'<b>Group_Loket</b>',width:200,sortable:true" halign="center"></th>
           
		   <th data-options="field:'id_group_layanan',title:'<b>Group_Layanan</b>',width:200,sortable:true" halign="center"></th>
           
		   <th data-options="field:'id_group_layanan_forward',title:'<b>Group_Layanan_Forward</b>',width:200,sortable:true" halign="center"></th>
