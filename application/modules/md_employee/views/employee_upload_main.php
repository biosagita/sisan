...
url = '<?php echo base_url(); ?>index.php/md_employee/fnemployeeUploadProcess/<?php echo $vemployeeId; ?>';
<?php } else { ?>
$('#frmUploademployee').form('clear');
url = '<?php echo base_url(); ?>index.php/md_employee/fnemployeeUploadProcess/';
	...
	$('#frmemployee').form('submit',{
		...
		success: function(result) {
			...
			if (result.success) {
				...
				window.parent.$('#25_dtgphotoemployeee').datagrid('reload');
