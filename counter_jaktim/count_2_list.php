...
print"<div id=title_data>Skip List</div>";
$tanggal_transaksi=date(Ymd);

$sql_ct=mysql_query("Select count(*)as ct from transaksi inner join layanan ON transaksi.id_layanan=layanan.id_layanan where status_transaksi='3' and transaksi.id_group_layanan='$_SESSION[id_group_layanan]' and tanggal_transaksi='$tanggal_transaksi'");
...
echo"<tr  id=td_row class=\"terang\"
			  ...
			  <td align=center id=dt><a href='proses.php?proses=undo&id_undo=$mk3[no_ticket]' id='btnundo'>Undo</a>			  
			  ";
$n3++;
}
print"</table>";
