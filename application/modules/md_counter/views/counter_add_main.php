...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmTitle">Data counter</div>
...
$(function() {
	$('#fldType').combobox({
		valueField:'f_counter_type_id',
		textField:'f_counter_type_name',
		mode:'remote',
		panelWidth:100,
		panelHeight:'auto',
		url:'<?php echo base_url(); ?>index.php/md_counter/fncounterTypeData/'
	});
