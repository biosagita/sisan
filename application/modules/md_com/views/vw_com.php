...
<table id="77_dtgcom" class="easyui-datagrid" data-options="title:'Data com',url:'<?php echo base_url(); ?>index.php/md_com/fncomData/',toolbar:'#77_tlbcom',rownumbers:true,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'f_com_id',title:'<b>Id</b>',hidden:true,width:40,sortable:true" halign="center"></th>
