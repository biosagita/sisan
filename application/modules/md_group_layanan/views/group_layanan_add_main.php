...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmTitle">Data Group Layanan</div>
			...
			<div class="frmItem">
				...
				<input name='no_start' id='no_start' class="easyui-validatebox" size="5" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>End No</label>
				<input name='no_end' id='no_end' class="easyui-validatebox" size="5" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Jml Ticket</label>
				<input name='jml_tiket' id='jml_tiket' class="easyui-validatebox" size="5" data-options="required:true">
			</div>
