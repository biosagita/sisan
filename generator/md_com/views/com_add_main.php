...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmTitle">Data com</div>
			...
			<div class="frmItem">
				<label>Com</label>
				<input name='f_com' id='f_com' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
			...
			<div class="frmItem">
				...
				<input name='f_com_status' id='f_com_status' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
