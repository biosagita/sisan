	...
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmItem">
				...
				<input name='f_destination_number' id='f_destination_number' class="easyui-validatebox" size="20" >
			</div>

			<div class="frmItem">
				<label>Count Send</label>
				<input name='f_count' id='f_count' class="easyui-numberbox" size="5" >
			</div>
