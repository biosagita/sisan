...
<table id="82_dtguser_group" class="easyui-datagrid" data-options="title:'Data user_group',url:'<?php echo base_url(); ?>index.php/md_user_group/fnuser_groupData/',toolbar:'#82_tlbuser_group',rownumbers:false,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'id',title:'<b>Id</b>',width:40,sortable:true" halign="center"></th>
           
		   <th data-options="field:'id_user_group',title:'<b>User_Group</b>',width:200,sortable:true" halign="center"></th>
           
		   <th data-options="field:'nama_user_group',title:'<b>User_Group</b>',width:250,sortable:true" halign="center"></th>
