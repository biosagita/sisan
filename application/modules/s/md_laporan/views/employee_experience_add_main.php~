...
<div class="easyui-layout" style="width:530px; height:330px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmTitle">Employee Experience</div>
			...
			<div class="frmItem">
				<label>Year</label>
				<input name='f_emp_experience_year' id='f_emp_experience_year' class="easyui-validatebox" size="5" data-options="required:true">
			</div>
			
			<div class="frmItem">
				<label>Company</label>
				<input name='f_emp_experience_company' id='f_emp_experience_company' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
			<div class="frmItem">
				<label>Businesses</label>
				<input name='f_emp_experience_businesses' id='f_emp_experience_businesses' class="easyui-validatebox" size="30" data-options="required:true">
			</div>			
 			<div class="frmItem">
				<label>Position</label>
				<input name='f_emp_experience_position' id='f_emp_experience_position' class="easyui-validatebox" size="30" data-options="required:true">
			</div>			
             

			<div class="frmItem">
				<label>Remark</label>
				<input name='f_emp_experience_remark' id='f_emp_experience_remark' class="easyui-validatebox" size="35" data-options="required:true">
			</div>
...
url = '<?php echo base_url(); ?>index.php/md_employee_educations/fnemployee_experienceCreate/';
<?php } ?>
<?php if(isset($vemployee_experienceId)) { ?>
$('#frmemployee').form('load','<?php echo base_url()?>index.php/md_employee_experience/fnemployee_experienceRow/<?php echo $vemployee_experienceId; ?>');
url = '<?php echo base_url(); ?>index.php/md_employee_experience/fnemployee_experienceUpdate/<?php echo $vemployee_experienceId; ?>';
<?php } else { ?>
$('#frmemployee').form('clear');
url = '<?php echo base_url(); ?>index.php/md_employee_experience/fnemployee_experienceCreate/';
<?php } ?>
...
function fnSaveData() {
	$('#frmemployee').form('submit',{
		...
		success: function(result) {
			...
			if (result.success) {
				window.parent.$('#25_dtgemployee_experience').datagrid('reload');
