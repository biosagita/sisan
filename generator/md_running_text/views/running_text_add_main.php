...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmTitle">Data running_text</div>
			
         
			<div class="frmItem">
				<label>Id</label>
				<input name='id_running_text' id='id_running_text' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Text</label>
				<input name='text' id='text' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Created_text</label>
				<input name='created_date' id='created_date' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Modified_Date</label>
				<input name='modified_date' id='modified_date' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Start_Date</label>
				<input name='start_date' id='start_date' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Expired_Date</label>
				<input name='expired_date' id='expired_date' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
...
$(function() {
	$('#fldType').combobox({
		valueField:'f_running_text_type_id',
		textField:'f_running_text_type_name',
		mode:'remote',
		panelWidth:100,
		panelHeight:'auto',
		url:'<?php echo base_url(); ?>index.php/md_running_text/fnrunning_textTypeData/'
	});
