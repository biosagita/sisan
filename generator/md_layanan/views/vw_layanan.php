<div id="79_tlblayanan" style="padding:5px;">
...
<table id="79_dtglayanan" class="easyui-datagrid" data-options="title:'Data layanan',url:'<?php echo base_url(); ?>index.php/md_layanan/fnlayananData/',toolbar:'#79_tlblayanan',rownumbers:false,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'id_layanan',title:'<b>Id</b>',width:40,sortable:true" halign="center"></th>
           
		   <th data-options="field:'nama_layanan',title:'<b>Nama_Layanan</b>',width:250,sortable:true" halign="center"></th>
           
		   <th data-options="field:'id_group_layanan',title:'<b>Group_Layanan</b>',width:150,sortable:true" halign="center"></th>
		   ...
		   <th data-options="field:'id_layanan_forward',title:'<b>Layanan_Barcode</b>',width:40,sortable:true" halign="center"></th>
           
		   <th data-options="field:'status_barcode',title:'<b>Status_Barcode</b>',width:50,sortable:true" halign="center"></th>
