...
<div class="easyui-layout" data-options="fit:true" style="background:#efefef;">
   <div data-options="region:'north',title:'',split:true" style="height:130px;padding:10px;">
	...
	<div style="float:left;" >
			<a href="javascript:void(0)" class="easyui-linkbutton" style="color:#fff;" onclick="fnUndo()">Undo</a>
	</div>			
...
function fnUndo() {
	var singleRow = $('#84B_dtgcounter').datagrid('getSelected');
	if (singleRow) {
		$.messager.confirm('Confirm','Are you sure you want to Undo this data?',function(res) {
			if (res) {
				
				$.post('<?php echo base_url(); ?>index.php/md_counter/fnUndo/',{Id:singleRow.id},function(result) {
