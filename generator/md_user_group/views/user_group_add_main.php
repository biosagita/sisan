...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmItem">
				<label>Id</label>
				<input name='id' id='id' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>User_Group</label>
				<input name='id_user_group' id='id_user_group' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>User_Group</label>
				<input name='nama_user_group' id='nama_user_group' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
...
$(function() {
	$('#fldType').combobox({
		valueField:'f_user_group_type_id',
		textField:'f_user_group_type_name',
		mode:'remote',
		panelWidth:100,
		panelHeight:'auto',
		url:'<?php echo base_url(); ?>index.php/md_user_group/fnuser_groupTypeData/'
	});
