...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmTitle">Data setting</div>
			
         
			<div class="frmItem">
				<label>Id</label>
				<input name='id_setting' id='id_setting' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Setting</label>
				<input name='setting' id='setting' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Nilai</label>
				<input name='nilai' id='nilai' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
	...
	<div data-options="region:'south',border:false" style="height:35px; background-color:#F8F8F8;">
		<div id="btnsetting" align="right" style="padding:5px;">
...
$(document).ready(function() {
	window.parent.$('#85_divWait').hide();
	window.parent.$('#85_frasetting').show();
});
<?php if(isset($vsettingId)) { ?>
$('#frmsetting').form('load','<?php echo base_url()?>index.php/md_setting/fnsettingRow/<?php echo $vsettingId; ?>');
url = '<?php echo base_url(); ?>index.php/md_setting/fnsettingUpdate/<?php echo $vsettingId; ?>';
<?php } else { ?>
$('#frmsetting').form('clear');
url = '<?php echo base_url(); ?>index.php/md_setting/fnsettingCreate/';
<?php } ?>
$.fn.validatebox.defaults.missingMessage = 'Must be filled.';
$(function() {
	$('#fldType').combobox({
		valueField:'f_setting_type_id',
		textField:'f_setting_type_name',
		mode:'remote',
		panelWidth:100,
		panelHeight:'auto',
		url:'<?php echo base_url(); ?>index.php/md_setting/fnsettingTypeData/'
	});
