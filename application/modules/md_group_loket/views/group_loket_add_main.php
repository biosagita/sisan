...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmTitle">Data Group Loket</div>
			
			<div class="frmItem">
				<label>Group_Loket</label>
				<input name='nama_group_loket' id='nama_group_loket' class="easyui-validatebox" size="30" data-options="required:true">
			</div>
			...
			<div class="frmItem">
				...
				<input name='id_group_layanan_forward' id='id_group_layanan_forward' size="20" data-options="required:true">
			</div>

			<div class="frmItem">
				<label>Voice Group </label>
				<input name='voice_group' id='voice_group' class="easyui-validatebox" size="5" data-options="required:true">
			</div>
...
$(function() {
	...
	$('#id_group_layanan_forward').combobox({
		valueField:'id_group_layanan',
		textField:'nama_group_layanan',
		mode:'remote',
		panelWidth:100,
