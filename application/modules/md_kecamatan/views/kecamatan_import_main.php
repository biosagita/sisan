...
<div class="easyui-layout" style="width:450px; height:130px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			<form name="frmImportcity" id="frmcity" method="post" accept-charset="utf-8" enctype="multipart/form-data" novalidate>
			 <p>&nbsp;&nbsp;</p>        
			<div class="frmItem">
...
$('#frmcity').form('load','<?php echo base_url()?>index.php/md_kecamatan/fncityRow/<?php echo $vcityId; ?>');
url = '<?php echo base_url(); ?>index.php/md_kecamatan/fncityUpdate/<?php echo $vcityId; ?>';
<?php } else { ?>
$('#frmcity').form('clear');
url = '<?php echo base_url(); ?>index.php/md_kecamatan/fncityImportProcess/';
