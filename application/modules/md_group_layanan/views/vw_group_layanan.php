    ...
    <div data-options="region:'center',title:'Data Group Layanan'" style="padding-bottom:25px;background:#eee;">
...
<table id="78_dtggroup_layanan" class="easyui-datagrid" data-options="title:'',url:'<?php echo base_url(); ?>index.php/md_group_layanan/fngroup_layananData/',toolbar:'#78_tlbgroup_layanan',rownumbers:true,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'id_group_layanan',title:'<b>Id</b>',hidden:true,width:40,sortable:true" halign="center"></th>
           
		   <th data-options="field:'nama_group_layanan',title:'<b>Nama Group</b>',width:200,sortable:true" halign="center"></th>
           
		   <th data-options="field:'no_start',title:'<b>Start NO</b>',width:60,sortable:true" halign="center"></th>
           
		   <th data-options="field:'no_end',title:'<b>End No</b>',width:60,sortable:true" halign="center"></th>
           
		   <th data-options="field:'jml_tiket',title:'<b>Jml Ticket</b>',width:80,sortable:true" halign="center"></th>
           
		   <th data-options="field:'keterangan',title:'<b>Keterangan</b>',width:350,sortable:true" halign="center"></th>
...
function fnAddgroup_layanan_78() {
	$('#78_dlggroup_layanan').dialog({
		title: 'Input Data group Layanan',
		width: 510,
		height: 390
	});
	$('#78_divWait').show();
