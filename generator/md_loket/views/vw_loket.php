<div id="81_tlbloket" style="padding:5px;">
...
<table id="81_dtgloket" class="easyui-datagrid" data-options="title:'Data loket',url:'<?php echo base_url(); ?>index.php/md_loket/fnloketData/',toolbar:'#81_tlbloket',rownumbers:false,border:false,singleSelect:true,striped:true,fit:true,pagination:true,pageSize:20,pageList:[20,50,100,500]">
<thead>
	<tr>
           
		   <th data-options="field:'id_loket',title:'<b>Id</b>',width:40,sortable:true" halign="center"></th>
           
		   <th data-options="field:'nama_loket',title:'<b>Nama_Loket</b>',width:200,sortable:true" halign="center"></th>
           
		   <th data-options="field:'id_group_loket',title:'<b>Group_loket</b>',width:200,sortable:true" halign="center"></th>
