...
<div class="easyui-layout" style="width:495px; height:300px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			<form name="frmRole" id="frmRole" method="post" novalidate>
			<div class="frmTitle">Data Role</div>
			<div class="frmItem">
				<label>Code</label>
			...
			<div class="frmItem">
				...
				<input name="fldBranchStatus" id="fldBranchStatus" missingMessage="Harus Diisi." style="width:100px;">
			</div>
			<div class="frmItem">
				<label>Data Limitations</label>
				<input name="fldDataLimitations" id="fldDataLimitations" missingMessage="Harus Diisi." style="width:100px;">
			</div>
			<div class="frmItem">
				<label>Category</label>
				<input name="fldCategory" id="fldCategory" missingMessage="Harus Diisi." style="width:100px;">
			</div>
			
			<div class="frmItem">
				<label>Active</label>
				<input name="fldActive" id="fldActive" missingMessage="Harus Diisi." style="width:100px;">
			</div>
			</form>
		</div>
	</div>
	<div data-options="region:'south',border:false" style="height:35px; background-color:#F8F8F8;">
		<div id="btnRole" align="right" style="padding:5px;">
...
<?php if(isset($vRoleId)) { ?>
$('#frmRole').form('load','<?php echo base_url()?>index.php/md_role_access/fnRoleRow/<?php echo $vRoleId; ?>');
url = '<?php echo base_url(); ?>index.php/md_role_access/fnRoleUpdate/<?php echo $vRoleId; ?>';
<?php } else { ?>
$('#frmRole').form('clear');
url = '<?php echo base_url(); ?>index.php/md_role_access/fnRoleCreate/';
<?php } ?>
...
$(function() {
	$('#fldAppl').combobox({
		...
		panelWidth:175,
		panelHeight:'auto',
		url:'<?php echo base_url(); ?>index.php/md_role_access/fnRoleApplData/'
	});
	$('#fldActive').combobox({
		...
		panelWidth:100,
		panelHeight:'auto',
		url:'<?php echo base_url(); ?>index.php/md_role_access/fnRoleActvData/'
	});
	$('#fldBranchStatus').combobox({
		valueField:'label',
		textField:'value',
	data:[{  
		label: 0,  
...
function fnSaveData() {
	$('#frmRole').form('submit',{
		...
		success: function(result) {
			...
			if (result.success) {
				window.parent.$('#74_dtgRole').datagrid('reload');
