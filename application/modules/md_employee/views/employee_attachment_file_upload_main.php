...
<body>
<div class="easyui-layout" style="width:535px; height:230px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			<form name="frmUploademployee" id="frmemployee" accept-charset="utf-8" enctype="multipart/form-data" method="post" novalidate>
			 <p>&nbsp;&nbsp;</p>
			...
			<div class="frmItem">
				<label>Remark</label>
				<input name='f_emp_attachment_file_remark' id='f_emp_attachment_file_remark' class="easyui-validatebox" size="35" data-options="required:true">
			</div>
	...
	<div data-options="region:'south',border:false" style="height:35px; background-color:#F8F8F8;">
		<div id="btnemployee" align="right" style="padding:5px;">
			...
			<div id="footBarRight" style="float:right; width:auto; clear:right;">
				<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-ok" onclick="fnSave()">Process Upload</a>
...
url = '<?php echo base_url(); ?>index.php/md_employee_attachment_file/fnemployee_attachment_file_UploadProcess/<? echo $vemployeeId; ?>';
<?php } else { ?>
$('#frmUploademployee').form('clear');
url = '<?php echo base_url(); ?>index.php/md_employee_attachment_file/fnemployee_attachment_file_UploadProcess/';


<?php } ?>
$.fn.validatebox.defaults.missingMessage = 'Must be content.';
	...
	$('#frmemployee').form('submit',{
		...
		success: function(result) {
			...
			if (result.success) {
				...
				window.parent.$('#25_dtgemployee_attachment_file').datagrid('reload');
