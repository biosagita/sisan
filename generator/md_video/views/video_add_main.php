...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			<form name="frmvideo" id="frmvideo" method="post" novalidate>
			<div class="frmTitle">Data video</div>
			
         
			<div class="frmItem">
				<label>Id</label>
				<input name='id_video' id='id_video' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>File</label>
				<input name='nama_video' id='nama_video' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
