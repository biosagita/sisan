...
<div class="easyui-layout" style="width:495px; height:350px; background-color:#FFF;">
	<div data-options="region:'center',border:false">
		<div style="padding:0px 15px;">
			...
			<div class="frmTitle">Data outbox_sms</div>
			
         
			<div class="frmItem">
				<label>Id</label>
				<input name='f_outbox_id' id='f_outbox_id' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Datetime</label>
				<input name='f_outbox_date' id='f_outbox_date' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Destination%20Number</label>
				<input name='f_destination_number' id='f_destination_number' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Message</label>
				<input name='f_outbox_message' id='f_outbox_message' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Com</label>
				<input name='f_com_id' id='f_com_id' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Status</label>
				<input name='f_outbox_status' id='f_outbox_status' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Remafk</label>
				<input name='f_outbox_remark' id='f_outbox_remark' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
       
			<div class="frmItem">
				<label>Sended%20%20Date</label>
				<input name='f_outbox_send_date' id='f_outbox_send_date' class="easyui-validatebox" size="20" data-options="required:true">
			</div>
...
url = '<?php echo base_url(); ?>index.php/md_outbox_sms/fnoutbox_smsCreate/';
<?php } ?>
$.fn.validatebox.defaults.missingMessage = 'Must be filled.';
$(function() {
	$('#fldType').combobox({
		valueField:'f_outbox_sms_type_id',
		textField:'f_outbox_sms_type_name',
		mode:'remote',
		panelWidth:100,
		panelHeight:'auto',
		url:'<?php echo base_url(); ?>index.php/md_outbox_sms/fnoutbox_smsTypeData/'
	});
